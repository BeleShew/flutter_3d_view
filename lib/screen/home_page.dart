...
class HomePage extends StatelessWidget {
  HomePage({super.key,required this.heroTag}) {
  // HomePage({super.key}) {
                          ...
                          Center(
                            child: Row(
                              ...
                              children: [
                                InkWell(
                                  onTap:(){
                                    if(controller.selectdColorIndex!=0) {
                                  ...
                                  Stack(
                                    children: [
                                      ...
                                      controller.selectdColorIndex==0?
                                      const Icon(Icons.check_circle,color: Colors.grey,size: 30,):Container()
                                    ],
                                  ),
                                ),
                                ...
                                InkWell(
                                  onTap:(){
                                    if(controller.selectdColorIndex!=1) {
                                ...
                                InkWell(
                                  onTap:(){
                                    if(controller.selectdColorIndex!=2) {
